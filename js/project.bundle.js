...
/***/ function(module, exports, __webpack_require__) {
	...
	var Positionable = __webpack_require__(3);
	...
	var Project = React.createClass({ displayName: "Project",
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", { className: "demo project" }, React.createElement("div", { className: "tile tile-demo" }, React.createElement("div", { className: "shadows" }, shadows), React.createElement("div", { className: "inner" }, React.createElement("div", { className: "positionables" }, positionables), React.createElement("div", { className: "controls" }, React.createElement("button", { className: "text component", onClick: this.addText }, "Aa"), React.createElement("button", { className: "image component", onClick: this.addImage }, "Image"), React.createElement("button", { className: "link component", onClick: this.addLink }, "<a>"), React.createElement("button", { className: "edit component", onClick: this.editCurrent }, "✎")))), React.createElement(Link, { ref: "editlink", url: "/project/123/1?data=" + JSON.stringify({
	        index: this.state.currentElement,
	        entry: this.state.content[this.state.currentElement]
	      }),
	      href: "/pages/editor", hidden: true }, "edit"));
	  },
	
	  formShadows: function formShadows(content) {
	    this.shadows = content.map(function (m, i) {
	      var element = Generator.generateBlock(m);
	      return React.createElement("div", null, React.createElement(Positionable, React.__spread({ ref: "shadow" + i, key: "shadow" + i }, m, { interactive: false }), element));
	    });
	    return this.shadows;
	  },
	  ...
	  formPositionables: function formPositionables(content) {
	    ...
	    return content.map(function (m, i) {
	      var element = Generator.generateBlock(m);
	      return React.createElement("div", null, React.createElement(Positionable, React.__spread({ ref: "positionable" + i, key: "positionable" + i }, m, { current: _this.state.currentElement === i, onUpdate: _this.updateElement(i) }), element));
	    });
	  },
	...
	var Positionable = React.createClass({ displayName: "Positionable",
	  ...
	  componentDidMount: function componentDidMount() {
	    if (!this.state.interactive) {
	      return;
	    }var touchHandler = this.touchhandler = __webpack_require__(10)(this);
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", null, React.createElement("div", { ref: "overlay", className: "touchOverlay", hidden: !this.state.touchactive }), React.createElement("div", { style: style, className: className }, this.props.children));
	  },
	...
	module.exports = function (positionable) {
	  return {
	    ...
	    panmove: function panmove(evt) {
	      ...
	      positionable.handleTranslation(x - positionable.transform.markx, y - positionable.transform.marky);
	    },
	    ...
	    handleRS: function handleRS(evt) {
	      if (evt.touches.length < 2) {
	        return;
	      }var x1 = positionable.transform.markx,
	          y1 = positionable.transform.marky,
