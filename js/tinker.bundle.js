...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tinker = React.createClass({ displayName: "Tinker",
	  ...
	  render: function render() {
	    return React.createElement("div", null, React.createElement("div", { className: "editor-preview" }, React.createElement("img", { src: "../../img/toucan.svg" })), React.createElement("div", { className: "editor-options" }, React.createElement("h3", null, "THIS IS TINKER MODE YO"), React.createElement("input", { type: "range" }), React.createElement("input", { type: "range" }), React.createElement("input", { type: "range" })));
	  }
	});
