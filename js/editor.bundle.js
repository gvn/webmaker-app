...
/***/ function(module, exports, __webpack_require__) {
	...
	var Editor = React.createClass({ displayName: "Editor",
	  ...
	  render: function render() {
	    return React.createElement("div", null, React.createElement("div", { className: "editor-preview" }, React.createElement("img", { src: "../../img/toucan.svg" })), React.createElement("div", { className: "editor-options" }, React.createElement("button", null, "Change Image"), React.createElement("label", null, "Transparency"), React.createElement("input", { type: "range" }), React.createElement("label", null, "Corners"), React.createElement("input", { type: "range" }), React.createElement(Link, { url: "/project/123/1/color", href: "/pages/tinker" }, "Tinker Mode")));
	  }
	});
