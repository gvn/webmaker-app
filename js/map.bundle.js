...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({ displayName: "App",
	  ...
	  zoomGridOut: function zoomGridOut() {
	    this.refs.masterGrid.zoomOut();
	  },
	  zoomGridIn: function zoomGridIn() {
	  ...
	  onZoomChange: function onZoomChange(event) {
	    this.setState({
	  ...
	  render: function render() {
	    return React.createElement("div", { id: "map-view", className: "zoom-" + this.state.zoomLevel }, React.createElement("div", { className: "headerBar" }, "Project Name"), React.createElement("div", { ref: "wrapper", className: "wrapper" }, React.createElement("div", null, React.createElement(Grid, { ref: "masterGrid", aspectRatio: "35:40", onZoomChange: this.onZoomChange }))), React.createElement("div", { className: "segmented-control" }, React.createElement(Hammer, {
	      className: this.state.zoomLevel > 0 ? "enabled" : "disabled",
	      component: "button",
	      onTap: this.zoomGridOut }, "-"), React.createElement(Hammer, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "exports",
	   ...
	   */
	  calculateCameraState: function calculateCameraState(pageX, pageY, pagesWide, doCentering) {
	    var cameraX = 0;
	    var cameraY = 0;
	  ...
	  onPageDoubleTap: function onPageDoubleTap(event) {
	    this.activeTile = {
	      x: event.x,
	      y: event.y
	    };
	   ...
	   */
	  setZoomLevel: function setZoomLevel(levelIndex) {
	    if (this.activeTile) {
	      this.calculateCameraState(this.activeTile.x, this.activeTile.y, this.zoomPresets[levelIndex], true);
	    } else {
	      // Show "midpoint"
	      this.calculateCameraState(Math.floor(this.tilesPerRow / 2), Math.floor(this.tilesPerCol / 2), this.zoomPresets[levelIndex], true);
	    }
	
	    this.currentZoomIndex = levelIndex;
	    this.animateCamera(true);
	  },
	  generateGrid: function generateGrid(width, height) {
	    var grid = [];
	  ...
	  addPageTap: function addPageTap(event) {
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    elGrid.addEventListener("touchmove", (function (event) {
	      if (this.currentZoomIndex !== 2) {
	        ...
	        elGrid.style.transform = "scale(" + (this.displayState.zoom || 1) + ") " + "translate3d(" + (this.displayState.cameraX + deltaX) + "px, " + (this.displayState.cameraY + deltaY) + "px, 0)";
	      }
	    }).bind(this));
	  ...
	  hasNeighbors: function hasNeighbors(x, y) {
	  ...
	  setContainerDimensions: function setContainerDimensions(width, height) {
	    this.setState({
	      containerWidth: width,
	      containerHeight: height
	    });
	  },
	  animateCamera: function animateCamera(animateZoom) {
	  ...
	  render: function render() {
	    ...
	    for (var y = 0; y < this.tilesPerCol; y++) {
	      for (var x = 0; x < this.tilesPerRow; x++) {
	        if (layout[y][x]) {
	          nodes.push(React.createElement(Slot, { x: x, y: y, style: slotStyle, key: y + "-" + x }, React.createElement(Page, { onDoubleTap: this.onPageDoubleTap.bind(this, { x: x, y: y }) })));
	        } else if (this.hasNeighbors(x, y)) {
	          nodes.push(React.createElement(Slot, { x: x, y: y, style: slotStyle, key: y + "-" + x },
	          /* Overriding default onTap param to provide x/y coords without AddPage knowing them. */
	          React.createElement(Hammer, { className: "add-page", onTap: this.addPageTap.bind(this, { x: x, y: y }) })));
	        } else {
	          nodes.push(React.createElement(Slot, { x: x, y: y, style: slotStyle, key: y + "-" + x }));
	        }
	      }
	    ...
	    return React.createElement("div", { className: "grid" }, nodes);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Link = React.createClass({ displayName: "Link",
	  render: function render() {
	    ...
	    return React.createElement("a", React.__spread({}, props));
	  }
	});
	...
	module.exports = React.createClass({ displayName: "exports",
	  render: function render() {
	    return React.createElement(Hammer, {
	      ...
	      className: "page" }, React.createElement(Link, { url: "/project/1234", href: "/pages/project" }, "EDIT"));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window, document, exportName, undefined) {
	    ...
	    Recognizer.prototype = {
	         ...
	         */
	        emit: (function (_emit) {
	            var _emitWrapper = function emit(_x) {
	                return _emit.apply(this, arguments);
	            };
	
	            _emitWrapper.toString = function () {
	    ...
	    if ("function" == TYPE_FUNCTION && __webpack_require__(103)) {
